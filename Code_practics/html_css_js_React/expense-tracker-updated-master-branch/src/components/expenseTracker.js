...
const ExpenseTracker = () => {
    ...
    const IncomeComponent = () => {
        ...
        return (
            <>
                <div  style={{display:"flex",  background: "#3a49998a",color: "white"}}>
    ...
    return (
        <div
            ...
            <Card style={{ width: 490, padding: "16px" }}>
                ...
                <TextField
                    sx={{ my: 2 }} fullWidth  label="Enter Item Price ($)"   type="number" id="item-price"  value={itemPrice} onChange={(event) => setItemPrice(event.target.value.slice(0, 3))} />
                ...
                {items.map((item, index) => (
                    <div
                        ...
                        <div style={{ display: "flex" }}> <p style={{ padding: "10px", marginBottom: "0" }}><span style={{fontWeight:"bold"}}>$</span>  {item.price}  </p>
