...
export const Mysummagicgame = () => {
    ...
    return (
        ...
        <Grid container style={{  minHeight:"10vh", border:"3px solid red"}}>


            <div id="firstsubcontainer">
                <
                Typography variant="h5" style={{backgroundColor: "blue", padding: "10px"}}>
            ...
            <div id="secondsubcontainer">
                ...
                <Button   onClick={handleRestartClick} style={{width:"100%"}}   size="large" variant="contained">Restart / Play again</Button>
                <div>
